...
function getColor(depth) {
    if (depth > 90) {
        ...
        return "#FFA500"; // Orange for depths greater than 70
    } else if (depth > 50) {
        return "#FFFF00"; // Yellow for depths greater than 50
    } else if (depth > 30) {
        return "#ADFF2F"; // Yellow-Green for depths greater than 30
    } else {
        return "#00FF00"; // Dark Green for depths less than or equal to 30
    }
}
